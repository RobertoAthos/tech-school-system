      ...
      {store.student.isAuthenticated ? (
        <>
          ...
          <div className="grades-container">
            <div className="obs-text"><h2><span>OBS:</span> Os campos que estiverem vazios, é por conta da nota ainda não ser lançada.</h2></div>
            {store.student.allMarks.CycleTest1 && (
              <div className="grades-content">
                <div className="infos">
                <h3>Português</h3>
                <div className="note"><p>Nota:</p></div>
                    ...
                    <>
                       <div className="table"> 
                          {store.student.allMarks.CycleTest1.map(
                            (res, index) => (
                              <div key={index}>
                                <span className="grade">{res.marks}</span>
                              </div>
                            )
                          )}
                      </div>
              ...
              <div  className="grades-content">
                ...
                <div className="note"><p>Nota:</p></div>
                  {store.student.allMarks.CycleTest9.length !== 0 ? (
                    <>
                        <div className="table">
                          {store.student.allMarks.CycleTest9.map(
                            (res, index) => (
                              <div key={index}>
                                <span className="grade">{res.marks}</span>
                              </div>
              ...
              <div className="grades-content">
                ...
                <div className="note"><p>Nota:</p></div>
                  {store.student.allMarks.CycleTest10.length !== 0 ? (
                    <>
                       <div className="table">
                          {store.student.allMarks.CycleTest10.map(
                            (res, index) => (
                              <div key={index}>
                                <span className="grade">{res.marks}</span>
                              </div>
